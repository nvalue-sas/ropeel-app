...
class FCMService {
  ...
  checkPermission = (onRegister) => {
    messaging()
      ...
      .then((enabled) => {
        if (enabled) {
          // User has permission
          console.info("checkPermission...enable...");
          this.getToken(onRegister);
        } else {
          // User don't have permission
          console.info("checkPermission. disable...");
          this.requestUserPermission(onRegister);
        }
      })
      .catch((error) => {
  ...
  requestUserPermission = async (onRegister) => {
    console.info('entra a requestUserPermission...')
  ...
  createNotificationListeners = (
    ...
    console.log("entrando a createNotificationListeners.onNotificationOpenedApp....")
    ...
    messaging()
      ...
      .then((remoteMessage) => {
        console.log(
          '[FCMService] getInitialNotification',
          remoteMessage,
        );
        if (remoteMessage) {
          const notification = remoteMessage;
